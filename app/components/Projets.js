...
const data = [
  { id: 1, title: "Dōmori", env: 'Mobile', description: 'Application de garde d’animaux de compagnie entre particuliers.', tags: ['Java', 'Android Studio', 'MySQL'], repo: 'https://github.com/Ukureii/Doomori', plus: '', imageUrl: '/doomori.png' },
  ...
  { id: 3, title: "Nexus", env: 'Web', description: 'Site de mise en relation pour joueurs de jeux vidéo de même niveau.', tags: ['PHP', 'CodeIgniter', 'MySQL'], repo: 'https://github.com/Ukureii/nexus', plus: '', imageUrl: '/nexus.png' },
